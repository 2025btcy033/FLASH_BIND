...
{Colors.END}"""
    ...
    print(f"{Colors.MAGENTA}●{'═' * 15} {Colors.WHITE}{Colors.BOLD}Flash Bind Tool {Colors.END}{Colors.MAGENTA}{'═' * 15}●{Colors.END}\n")
    
    print(f" {Colors.GREEN}⊛ DEVELOPER : {Colors.WHITE}@flashff07{Colors.END}")
...
def owner_details():
    ...
    print(f" \033[96m⊛ Developer Name :\033[0m \033[97mFLASH\033[0m")
    print(f" \033[96m⊛ Telegram       :\033[0m \033[97m@flashff07 AND @FLASHFF_07\033[0m")
    print(f" \033[96m⊛ Channel / Group:\033[0m \033[97mt.me/flashff07 AND t.me/FLASHFF_07\033[0m")
    ...
    print(f" \033[93mThank you for using Flash's Bind Tool!\033[0m")
